...
export class ContactComponent implements OnInit, OnDestroy {
  ...
  // Event handlers
  handleContactClick(info: ContactInfo): void {
  ...
  private async submitForm(formData: any): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        Math.random() > 0.15 ? resolve() : reject();
      }, 1500);
    });
  }
  ...
  private handleSubmitSuccess(): void {
    ...
    this.submitMessage = 'Message sent! I\'ll reply within 24 hours.';
    this.clearDraft();
  ...
  private handleSubmitError(): void {
    ...
    this.clearSubmitMessageAfterDelay(4000);
  }
